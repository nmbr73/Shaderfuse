...
function ShaderFuse.end_create()
    ...
    if deployment_phase == 1 then
        ...
        if version_info ~= '' then
            version_info = '<span style="color:#4060ff; ">'.. version_info ..'</span>'
        end

        self:AddInput('<p align="left">'
            ..'Shadertoy <a href="https://www.shadertoy.com/view/'.. ShaderFuse.Shadertoy.ID ..'" style="color:white; text-decoration:none; ">'.. ShaderFuse.Shadertoy.Name ..'</a> by <a href="https://www.shadertoy.com/user/'.. ShaderFuse.Shadertoy.Author ..'" style="color:yellow; text-decoration:none; ">'.. ShaderFuse.Shadertoy.Author ..'</a><br />'
            ..'<span style="color:#ff6060; ">'.. ShaderFuse.Shadertoy.License ..'</span><br />'
            ..'DCTLified and DaFused by <a href="'.. (ShaderFuse.Fuse.AuthorURL == '' and "https://nmbr73.github.io/Shadertoys/" or ShaderFuse.Fuse.AuthorURL) ..'" style="color:yellow; text-decoration:none; ">'.. ShaderFuse.Fuse.Author ..'</a><br />'
            ..version_info
            .. '</p>',
            "DctlFuseInfoLabel", {
...
--        self:AddInput('<p align="right"><a href="https://github.com/nmbr73/Shadertoys"><img '..
--            ShaderFuse.Fuse.AuthorLogo ..' /></a></p>',"DctlFuseLogoLabel", {ICS_ControlPage = (FC_AUTHIMGPOS == 2 and 'Info' or nil),IC_ControlPage=(FC_AUTHIMGPOS == 2 and 1 or FC_AUTHIMGPOS),LINKID_DataType = "Text",INPID_InputControl = "LabelControl",LBLC_MultiLine = true,IC_NoLabel = true,IC_NoReset = true,INP_External = false,INP_Passive = true,}) end end
    elseif deployment_phase == 2 then
    ...
    elseif deployment_phase == 3 then
       ...
       -- Info Btn
        ...
        local SHADERFUSES_REACTOR_PACKAGE_VERSION = 1
        local SHADERFUSES_REACTOR_PACKAGE_DATE = '1.4.1973'
    ...
    if ShaderFuse.Fuse.AuthorLogo then
        self:AddInput('<p align="right"><a href="https://github.com/nmbr73/Shadertoys"><img '.. ShaderFuse.Fuse.AuthorLogo ..' /></a></p>',
        "DctlFuseLogoLabel", {
--            ICS_ControlPage = (FC_AUTHIMGPOS == 2 and 'Info' or nil),
            IC_ControlPage = 1,
            LINKID_DataType = "Text",
            INPID_InputControl = "LabelControl",
            LBLC_MultiLine = true,
...
function ShaderFuse.init(filepath)
    ...
    if deployment_phase >= 2 then
        info.FuRegister.Attributes.REG_Fuse_NoEdit = true
        info.FuRegister.Attributes.REG_Fuse_NoReload = true
    end
