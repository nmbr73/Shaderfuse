...
function ShaderFuse.begin_create()
    ...
    -- Bei Gelegehnheit die GitHub Pages so umstrukturieren, daß die Informationen unter
    -- der Shadertoy-ID abgelegt werden. Dabei ggf. eine Variant für Dev und eine für Reactor
    -- generieren.

    local url = 'https://nmbr73.github.io/Shadertoys/Shaders/'.. info.Fuse.Category ..'/'.. info.Fuse.FileName ..'.html'
    ...
    -- The 'dev' variant of the branding:
    --
