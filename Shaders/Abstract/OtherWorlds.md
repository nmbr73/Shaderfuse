...
3) Scene frequency - This can be used to change the timing of the camera flight independently of the other timings. If you want to change the timing of all animations equally, there is the standard parameter "Frequency". Manual timing (Actime) is also possible with the "stop" checkbox.
4) bump map
...
6) The surface level (surface level) refers to the bright lights that can be changed with this.
7) Diffuse, Reflect, Specular and Ambient speak for themselves. 
8) Fog
